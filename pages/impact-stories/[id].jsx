...
const impactStories = [
  {
    ...
    content: `
      ...
      <p>In January 2024, RWWS partnered with local leaders to implement a comprehensive water solution for the village. The project included:</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>RWWS's Education for All Initiative was launched in September 2023 with the goal of providing quality education to 1,000 underprivileged children in this area. The program takes a holistic approach to education, addressing not just academic needs but also the broader challenges that prevent children from learning effectively.</p>
...
export default function ImpactStoryDetail({ params }) {
  ...
  useEffect(() => {
    ...
    const fetchStory = () => {
      const foundStory = impactStories.find(
