...
export const metadata = {
  ...
  description: 'Learn about our mission, vision, team, and the impact we\'re making around the world',
}
...
const milestones = [
  {
    ...
    description: "Hope Foundation was established with a mission to create sustainable change in underserved communities."
  },
  {
    year: 2008,
    title: "First Water Project",
    description: "Completed our first clean water project, providing access to safe drinking water for 5,000 people."
  },
  {
    year: 2010,
    title: "Education Initiative Launch",
    description: "Launched our Education for All initiative, building 10 schools and training 50 teachers."
  },
  {
    year: 2013,
    title: "Healthcare Program Expansion",
    description: "Expanded healthcare programs to 5 countries, establishing 15 community health centers."
  },
  {
    year: 2016,
    title: "Humanitarian Award",
    description: "Received the Global Humanitarian Award for our work in disaster relief and recovery."
  },
  {
    year: 2019,
    title: "One Million Lives Impacted",
    description: "Reached the milestone of positively impacting one million lives through our various programs."
  },
  {
    year: 2022,
    title: "Climate Resilience Initiative",
    description: "Launched a new initiative focused on helping communities adapt to climate change."
  },
  {
    year: 2024,
    title: "Digital Inclusion Program",
    description: "Started a digital literacy program to bridge the technology gap in underserved communities."
  }
]
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      To empower communities through sustainable development programs and immediate relief efforts, creating lasting change and building resilience in the face of challenges.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      A world where every person has access to the basic necessities of life, quality education, healthcare, and the opportunity to thrive in a sustainable environment.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Integrity, Compassion, Sustainability, Collaboration, Innovation, and Accountability guide all our work and relationships with communities, partners, and supporters.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-3xl mx-auto">
              We believe in sustainable, community-led development that addresses immediate needs while building long-term resilience.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  We partner with local organizations, governments, and international institutions to leverage resources and expertise for maximum impact.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-3xl mx-auto">
              Our dedicated team brings decades of experience in international development, humanitarian work, and non-profit management.
            </p>
          </div>
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Our History & Milestones</h2>
            <p className="text-lg max-w-3xl mx-auto">
              Since our founding in 2005, Hope Foundation has grown from a small grassroots organization to a global non-profit making an impact in over 50 countries.
            </p>
          </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={milestone.year} className={`relative flex items-center ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
                  ...
                  <div className="flex-1">
                    <Card className={`max-w-md ${index % 2 === 0 ? 'ml-auto mr-8' : 'ml-8'}`}>
                      <CardContent className="p-6">
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">Our Partners & Supporters</h2>
            <p className="text-lg max-w-3xl mx-auto">
              We collaborate with a diverse network of organizations to maximize our impact and reach.
            </p>
          </div>
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            <TabsContent value="ngo">
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8">
                {partners.filter(p => p.type === "NGO").map((partner) => (
                  <div key={partner.id} className="flex flex-col items-center">
                    <div className="relative w-24 h-24 bg-muted rounded-lg overflow-hidden mb-2">
                      <Image 
                        src={partner.logo} 
            ...
            <TabsContent value="corporate">
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8">
                {partners.filter(p => p.type === "Corporate Partner").map((partner) => (
                  <div key={partner.id} className="flex flex-col items-center">
                    <div className="relative w-24 h-24 bg-muted rounded-lg overflow-hidden mb-2">
                      <Image 
                        src={partner.logo} 
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-lg max-w-3xl mx-auto mb-6">
              We're always looking for new partnerships to expand our impact. If your organization shares our values and mission, we'd love to explore collaboration opportunities.
            </p>
            <Button asChild>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6">
                We are committed to transparency and accountability in all our operations. 85% of every dollar donated goes directly to our programs, with 10% for administrative costs and 5% for fundraising.
              </p>
              <p className="text-lg mb-6">
                Our financial statements are audited annually by independent auditors, and we publish detailed reports on our website.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild variant="outline">
                  <Link href="/about/accountability">Our Accountability Practices</Link>
                </Button>
              </div>
            </div>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Whether you want to donate, volunteer, or apply for aid, there are many ways to get involved with Hope Foundation.
          </p>
