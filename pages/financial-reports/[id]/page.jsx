...
import { ArrowLeft, Download, FileText, Calendar, ChevronRight } from 'lucide-react'
...
const financialReports = [
  {
    ...
    content: `
      ...
      <p>The year 2024 marked significant growth and impact for Hope Foundation. Through the generous support of our donors and the dedication of our team, we expanded our reach to serve more communities in need while maintaining high standards of efficiency and transparency.</p>
...
export default function FinancialReportDetail({ params }) {
  ...
  useEffect(() => {
    ...
    const fetchReport = () => {
      const foundReport = financialReports.find(r => r.id === parseInt(params.id))
  ...
  if (!report) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="mb-8">The financial report you're looking for doesn't exist or has been removed.</p>
        <Button asChild>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Financial Breakdown</h2>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: report.content }}></div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 max-w-3xl mx-auto">
            Access the complete financial report including detailed statements, notes, and auditor's opinion.
          </p>
          <Button size="lg">
            <Download className="mr-2 h-5 w-5" /> Download PDF ({report.fileSize})
          </Button>
        </div>
      </section>
    </div>
