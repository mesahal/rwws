...
export const metadata = {
  title: 'Financial Reports - Hope Foundation',
  description: 'Access our audited financial statements and annual reports for complete transparency',
}
...
const financialReports = [
  {
    ...
    type: "Annual Report",
    description: "Comprehensive overview of our financial performance, program impacts, and organizational growth in 2024.",
    date: "March 15, 2025",
    fileSize: "2.5 MB",
    highlights: [
  ...
  },
  {
    ...
    description: "Detailed financial statements and performance metrics for the fourth quarter of 2024.",
  ...
  },
  {
    ...
    type: "Audit Report",
    description: "Independent auditor's assessment of our financial statements and internal controls.",
  ...
  },
  {
    ...
    type: "Impact Report",
    description: "Detailed analysis of our programs' social impact and beneficiary outcomes.",
    date: "March 1, 2025",
    fileSize: "3.1 MB",
    highlights: [
...
const types = ["All Types", "Annual Report", "Quarterly Report", "Audit Report", "Impact Report"]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">Charity Navigator Rating</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-3xl mx-auto">
              We believe in complete transparency in our operations. Our financial reports are independently audited and publicly available to ensure accountability to our donors and beneficiaries.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold mb-6">Understanding Our Financials</h2>
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  Our financial reports provide detailed insights into how we allocate and utilize donor funds. Here's a quick guide to understanding our financial statements:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <ArrowRight className="h-5 w-5 text-primary mr-2 mt-1" />
                    <span>Program expenses represent direct costs of our humanitarian projects</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="h-5 w-5 text-primary mr-2 mt-1" />
                    <span>Administrative costs include operational and staff expenses</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRight className="h-5 w-5 text-primary mr-2 mt-1" />
                    <span>Fundraising expenses help us maintain and grow our donor base</span>
                  </li>
                </ul>
              </div>
            </div>
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Our finance team is happy to answer any questions about our financial reports or provide additional information about our financial practices.
              </p>
              <Button asChild>
