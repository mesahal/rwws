...
export const metadata = {
  ...
  description: 'Stay informed about our latest initiatives, events, and impact stories',
}
...
const newsItems = [
  ...
  },
  {
    ...
    date: "April 10, 2025",
    excerpt: "Recognized for outstanding contributions to community development and sustainable solutions for poverty alleviation worldwide.",
  ...
  },
  {
    ...
    date: "March 22, 2025",
    excerpt: "Our flagship clean water program has now provided safe drinking water to over 500,000 people across 100 villages in rural areas.",
  ...
  },
  {
    ...
    excerpt: "Our Education for All initiative is expanding to 10 additional schools, providing quality education to 5,000 more children.",
  ...
  },
  {
    ...
    excerpt: "Our 2024 annual report reveals significant growth in all program areas and improved efficiency in resource allocation.",
  ...
  },
  {
    ...
    excerpt: "Our emergency response team has been deployed to provide immediate relief to communities affected by severe flooding in Southeast Asia.",
  ...
  },
  {
    ...
    excerpt: "Five new mobile health clinics will bring essential healthcare services to remote communities with limited access to medical facilities.",
...
const categories = ["All Categories", "Events", "Partnerships", "Awards", "Programs", "Reports", "Emergency Relief", "Healthcare"]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="p-6 flex flex-col justify-between">
                    <div>
                      ...
                      <h2 className="text-2xl font-bold mb-4">{newsItems[0].title}</h2>
