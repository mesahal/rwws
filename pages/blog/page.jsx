...
export const metadata = {
  title: 'Blog & Knowledge Hub - Hope Foundation',
  description: 'In-depth articles, research findings, and expert opinions on humanitarian issues and sustainable development',
}
...
const blogPosts = [
  {
    ...
    excerpt: "Exploring innovative and sustainable approaches to providing clean water access in rural communities facing water scarcity.",
  ...
  },
  {
    ...
    excerpt: "How digital technologies can transform education in underserved communities while addressing challenges of access and equity.",
  ...
  },
  {
    ...
    excerpt: "Practical approaches to building climate resilience in communities most vulnerable to the impacts of climate change.",
  ...
  },
  {
    ...
    excerpt: "Why community-led approaches lead to more sustainable and effective development outcomes, with case studies from our programs.",
  ...
  },
  {
    ...
    authorImage: "https://images.unsplash.com/photo-1559582798-678dfc71ccd8?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    excerpt: "Innovative approaches to delivering quality healthcare in areas with limited resources and infrastructure.",
  ...
  },
  {
    ...
    authorImage: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    excerpt: "How to effectively measure the true impact of humanitarian and development programs beyond quantitative metrics.",
  ...
  },
  {
    ...
    authorImage: "https://images.unsplash.com/photo-1573497620053-ea5300f94f21?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    excerpt: "How focusing on women's empowerment creates ripple effects that benefit entire communities and economies.",
    image: "https://images.unsplash.com/photo-1573164713712-03790a178651?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
    category: "Research",
  ...
  },
  {
    ...
    excerpt: "Emerging technologies that are transforming humanitarian response and development work around the world.",
...
const categories = ["All Categories", "Research", "Opinion", "Case Study", "Innovation", "Methodology", "Technology"]
              ...
              <Card key={post.id} className="overflow-hidden">
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {post.tags.map((tag) => (
                      <span key={tag} className="inline-flex items-center bg-muted px-2 py-1 rounded-full text-xs">
      ...
      <section className="py-16 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 max-w-3xl mx-auto">
            Are you an expert in humanitarian work, sustainable development, or related fields? 
            We welcome guest contributions to our knowledge hub.
          </p>
          <Button asChild>
