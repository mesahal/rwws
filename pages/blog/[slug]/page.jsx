  ...
  if (!post) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="mb-8">The blog article you're looking for doesn't exist or has been removed.</p>
        <Button asChild>
          <Link href="/blog">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {post.tags.map((tag) => (
                    <span key={tag} className="inline-flex items-center bg-muted px-3 py-1 rounded-full text-sm">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {post.gallery && post.gallery.map((image, index) => (
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="mb-4 text-muted-foreground">Subscribe to our newsletter to receive the latest articles and updates.</p>
